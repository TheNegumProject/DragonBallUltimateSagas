...
type 			= ChangeState
value 		        = 3810
triggerall 		= (Command = "drago") && (Power >= 3000)
...
triggerall = p2stateno !=[1000,59999999] ;para o char nao sair do projectile thanks frs games
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 1500
...
value = 100
triggerall = command = "FF"
triggerall = p2stateno !=[1000,5999999];para o char nao sair do projectile thanks frs games
triggerall = alive = 1
trigger1 = ctrl = 1
...
triggerall = command != "holddown"
triggerall = p2stateno !=[1000,59999]
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = stateno = 1500
...
value = 105
triggerall = command = "BB"
triggerall = p2stateno !=[1000,59999];para o char nao sair do projectile thanks frs games
triggerall = alive = 1           
trigger1 = ctrl = 1
trigger1 = stateno >= 150
trigger2 = Stateno <= 153
...
;-------------------------------------------------------------------------------
; Jump Slegends a no ar
[State -1, Jump Slegends a]
type = ChangeState
value = 30101
triggerall = command ="db1"
triggerall = power >= 10
trigger1 = statetype != C
trigger1 = ctrl
...
; Jump Slegends b no ar
[State -1, Jump Slegends b]
type = ChangeState
value = 3010
triggerall = command ="db2"
triggerall = power >= 100
trigger1 = statetype != C
trigger1 = ctrl
...
; Jump Slegends c no ar
[State -1, Jump Slegends c]
type = ChangeState
value = 30102
triggerall = command ="db3"
triggerall = power >= 1000
trigger1 = statetype != C
trigger1 = ctrl
...
;-------------------------------------------------------------------------------
 ...
 ;Special air fireball
[State -1,state]
type = ChangeState
value = 41001
triggerall = power >= 500
trigger1  = command ="DB_z1"
trigger2  = command ="DB_z2"
trigger3  = command ="DB_z"
trigger1 = statetype = A
trigger1 = ctrl
...
trigger1 = ctrl || (stateno = 100 && animelemtime(3) >1) || stateno = 101
